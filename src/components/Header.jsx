    ...
    <header className="border-b border-gray-200">
      <nav className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a href="https://forms.gle/XKA4gsYefJPyRAYB6" className="hidden md:inline-block text-sm font-semibold bg-red-700 text-white px-4 py-2 rounded font-aderos reg-btn">REGISTER</a>
          <button
            type="button"
      ...
      {open && (
        <div className="md:hidden border-t bg-white">
          <div className="max-w-6xl mx-auto px-6 py-4">
            ...
            <div className="mt-4">
              <a href="https://forms.gle/XKA4gsYefJPyRAYB6"  className="inline-block bg-red-700 text-white px-4 py-2 rounded font-aderos">REGISTER</a>
            </div>
          </div>
        </div>
      )}
